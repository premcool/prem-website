    ...
    <Link href="/" className={`flex items-center gap-2 group ${className}`}>
      ...
      <div className="relative">
        ...
        >
          {/* Cloud shape */}
          <path
            d="M24 14C24.5304 14 25.0391 14.2107 25.4142 14.5858C25.7893 14.9609 26 15.4696 26 16C26 16.5304 25.7893 17.0391 25.4142 17.4142C25.0391 17.7893 24.5304 18 24 18H8C7.46957 18 6.96086 17.7893 6.58579 17.4142C6.21071 17.0391 6 16.5304 6 16C6 15.4696 6.21071 14.9609 6.58579 14.5858C6.96086 14.2107 7.46957 14 8 14H10C10 11.7909 11.7909 10 14 10C15.3807 10 16.6307 10.5571 17.5355 11.4645C18.4429 12.3693 19 13.6193 19 15H24Z"
